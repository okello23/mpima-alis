        ...
        <div class="col-md-8">
    		   {{ Form::open(array('route' => array('stock.saveUsage', $stock->id), 'method' => 'POST')) }}
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('date_of_usage', old('date_of_usage'),
                ...
                <div class="form-group">
                    ...
                    @foreach($requests as $request)
                        ...
                        <div class="radio col-sm-offset-3">
                            <label>
                                <input type="radio" name="request_id" id="request_id" value="{{$request->id}}" {{ ($record == $request->id||old('request_id')) ? 'checked' : ''}}>
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('issued_by', old('issued_by'), array('class' => 'form-control')) }}
                </div>
                <div class="form-group">
                    {{ Form::label('received-by', trans('messages.received-by')) }}
                    {{ Form::text('received_by', old('received_by'), array('class' => 'form-control')) }}
                </div>
                <div class="form-group">
